...
// Function creating courses Custom Post Type 
...
// Function for Events Custom Post Type
...
// Function for Members Area Custom Post Type
function members_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Members Area', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'revisions' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function teams_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Teams Area', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'revisions' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function clients_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Clients Area', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'revisions' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
// Function for Testimonial Area Custom Post Type
function testimonials_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Testimonials Area', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'revisions' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
