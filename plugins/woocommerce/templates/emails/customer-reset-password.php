...
<p>
	<a class="link" href="<?php echo esc_url( add_query_arg( array( 'key' => $reset_key, 'id' => $user_id ), wc_get_endpoint_url( 'reset-password', '', wc_get_page_permalink( 'reset-password' ) ) ) ); ?>"><?php // phpcs:ignore ?>
